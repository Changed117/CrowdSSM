...
<script type="text/javascript">
    ...
    function initPagination() {
        ...
        var properties = {
            ...
            callback: pageSelectCallback, //点击按钮后执行的回调函数
            current_page: ${requestScope.pageInfo.pageNum - 1 }, //当前页，默认是0
            prev_text: "上一页",
            next_text: "下一页",
    ...
    // 回调函数交给pagination使用
    // pageIndex是pagination传来的页码，与后端交互的时候需要 + 1
                    ...
                    <form action="admin/get/page.html" method="post" class="form-inline" role="form" style="float:left;">
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                ...
                                <input name="keyword" class="form-control has-success" type="text" placeholder="${param.keyword}">
                            </div>
                        </div>
